"""ZipRecruiter job scraper placeholder.
...
class ZipRecruiterScraperAgent(BaseJobScraperAgent):
    """Placeholder scraper for ZipRecruiter."""

    PLATFORM_NAME = "ziprecruiter"

    def login(self) -> bool:
        raise NotImplementedError("ZipRecruiter scraper is not yet implemented")
